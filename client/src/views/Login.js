...
navigate("/register")
  ...
  const login =()=>{
    axios.post("http//:localhost:9000/login",user).then(console.log(res=>res.data.message))
  }
  return (
    <>
      <div >
          ...
          <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
            ...
            <form className="mt-6">
              ...
              <div className="flex items-center justify-center mt-8">
                ...
                <button onClick={goToRegister} className="text-white py-2 px-4 uppercase rounded bg-indigo-500 hover:bg-indigo-600 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">
                  Sign up
                </button>
              </div>
            </form>
